...
ActiveRecord::Schema.define(version: 20_210_107_155_217) do
  create_table 'autor_comment_votes', force: :cascade do |t|
    ...
    t.index %w[autor_id comment_id], name: 'index_autor_comment_votes_on_autor_id_and_comment_id', unique: true
